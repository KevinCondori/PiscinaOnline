...
<body>
    <header class="clearfix">
        ...
        <div id="logo" class="clearfix">
          ...
          <div>N FACTURA:           {{$new_invoice->invoice_number}}</div>
        ...
        <div id="logo">
          ...
          <div><span>CLIENTE</span> {{$new_invoice->invoice_name}}</div>
          <div><span>NIT/CI</span> {{$new_invoice->invoice_ci_customer}}</div>
          {{--<div><span>EMAIL</span> <a href="mailto:john@example.com">john@example.com</a></div>--}}
          <div><span>FECHA</span> {{$new_invoice->invoice_date}}</div>
        ...
        <table>
          ...
          <tbody>
            ...
            {{--@foreach (App\Models\Consumption::join('products','consumptions.product_id','products.id')
              ...
              ->select('products.product_name', 'products.product_description', 'products.product_price', 'consumptions.consumption_amount','consumptions.consumption_date', 'consumptions.customer_id')->get() as $invoice_detail)
--}}
            @foreach ($order as $invoice_detail)
            ...
            <tr>
              ...
              <td class="total">{{$price_report}}</td>
            </tr>
            <tr>
                <!--sumar los datos de la factura y hacer los reportes-->
              <td colspan="4">INGRESO</td>
              <td class="total">Bs. {{$new_invoice->invoice_entryprice}}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="grand total">{{$report_final_price}}</td>
            </tr>
          </tbody>
        </table>
        <div id="notices">
        ...
        --}}
        <center><p>CÓDIGO DE CONTROL: {{$new_invoice->invoice_control}}</p></center>
        <center><p>FECHA DE LÍMITE DE EMISIÓN: {{$new_invoice->invoice_limit_date}}</p></center>
